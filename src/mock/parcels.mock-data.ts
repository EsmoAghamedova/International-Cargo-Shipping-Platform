...
export const mockParcels: ParcelRequest[] = [
    {
        ...
        messages: [
            { from: "USER", text: "When will it arrive?", at: "2025-08-16T15:00:00Z" },
            { from: "COMPANY", text: "Estimated delivery tomorrow.", at: "2025-08-16T16:00:00Z" },
        ],
    },
    {
        id: "p2",
        ...
        timeline: [
            { status: "PENDING_REVIEW", at: "2025-08-18T09:00:00Z" },
        ],
